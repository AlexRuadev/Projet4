 ...
 */
final class Version20190417141806 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , entreprises_nom VARCHAR(45) DEFAULT NULL COLLATE BINARY, entreprises_effectifs INTEGER DEFAULT NULL, entreprises_adresse VARCHAR(255) DEFAULT NULL COLLATE BINARY, entreprises_cp INTEGER DEFAULT NULL, entreprises_ville VARCHAR(45) DEFAULT NULL COLLATE BINARY, entreprises_telephone VARCHAR(13) DEFAULT NULL COLLATE BINARY, entreprises_siret INTEGER DEFAULT NULL, entreprises_description CLOB DEFAULT NULL COLLATE BINARY, entreprises_horaires CLOB DEFAULT NULL COLLATE BINARY, entreprises_capacite INTEGER DEFAULT NULL, entreprises_note DOUBLE PRECISION DEFAULT NULL, entreprises_tarif CLOB DEFAULT NULL COLLATE BINARY, entreprises_espace_exterieur BOOLEAN DEFAULT NULL, entreprises_status BOOLEAN NOT NULL, entreprises_date_creation DATETIME NOT NULL, entreprises_date_modif DATETIME DEFAULT NULL)');
